...
const Root = styled('div')(() => ({
    ...
    '[data-loop-theme="light"] & .para': { color: '#6B7280' },
    '[data-loop-theme="light"] & .muted': { color: '#6B7280' },
    '[data-loop-theme="light"] & .signin': { color: '#6B7280' },
    '& .sdk': { display: 'flex', alignItems: 'center', gap: 14, background: '#141A21', border: '1px solid #1F2937', borderRadius: 10, padding: '12px 14px', marginBottom: 12 },
    '& .sdkTag': { flex: '0 0 44px', width: 44, height: 44, borderRadius: 8, background: '#0A1A05', color: '#4ADE80', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'JetBrains Mono', monospace", fontSize: 11, fontWeight: 700, textTransform: 'uppercase' },
    '& .sdkName': { color: '#E5E7EB', fontSize: 14, fontWeight: 600, fontFamily: "'JetBrains Mono', monospace", textTransform: 'capitalize' },
    '& .sdkBtn': { marginLeft: 'auto', cursor: 'pointer', background: '#444444', color: '#fff', border: 'none', borderRadius: 8, padding: '8px 18px', fontSize: 13, fontFamily: 'inherit' },
