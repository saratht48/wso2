...
const Root = styled('div')(() => ({
    ...
    '& .h2': { fontFamily: "'JetBrains Mono', monospace", fontSize: 26, fontWeight: 700, lineHeight: '100%', color: '#E8EDF2', margin: '0 0 16px' },
    ...
    '& .epBtn': { cursor: 'pointer', background: 'none', border: `1px solid ${ORANGE}`, color: ORANGE, borderRadius: 10, padding: '13px 22px', fontSize: 16, fontFamily: 'inherit' },
    '& .epBtnGhost': { cursor: 'pointer', background: 'none', border: '1px solid #FFFFFF33', color: '#E5E7EB', borderRadius: 10, padding: '13px 22px', fontSize: 16, fontFamily: 'inherit' },
    '[data-loop-theme="light"] & .epBtnGhost': { color: '#374151', border: '1px solid #D1D5DB' },
    '& .epBtnPostman': { cursor: 'pointer', background: '#0A0A0A', border: '1px solid #FFFFFF4D', color: '#E5E7EB', borderRadius: 10, padding: '13px 22px', fontSize: 16, fontFamily: 'inherit' },
